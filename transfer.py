...
class Controller:
    def __init__(self, avatar, conductor, education):
        self.avatar = avatar
...
class Conductor:
    all_places = [places.Place('Cat_island', places.Point(-100.0, 50.0), []),
    ...
    all_humans = [[animals.Human('Kate', 'female', 20, 50, 100,
    ...
    all_arenas = [places.Arena('Cat_coliseum', all_places[0].get_point(), all_humans[0], 0),
                  places.Arena('Dog_combat', all_places[1].get_point(), all_humans[1], 1),
                  places.Arena('Human_stadium', all_places[2].get_point(), all_humans[2], 0),
                  places.Arena('Bloodbath', all_places[3].get_point(), all_humans[3], 0), ]

    for i in range(4):
        all_places[i].get_in(all_humans[i])
